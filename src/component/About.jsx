...
const About = () => {
  return (
    ...
    <div className="grid grid-cols-3 max-md:grid-cols-1">  
        ...
        <p className="bg-green-300 border-2 h-96 w-96 text-center justify-center p-8 m-10 pt-12" style={{borderRadius:"30%"}}>
        <div className="text-xl font-bold  text-blue-900 mb-5">
        ...
        <p className="bg-gray-300 border-2 h-96 w-96 text-center justify-center p-8 m-10 pt-12" style={{borderRadius:"30%"}}>
        <div className="text-xl font-bold  text-blue-900 mb-5">
        ...
        <p className="bg-yellow-300 border-2 h-96 w-96 text-center justify-center p-8 m-10 pt-12" style={{borderRadius:"30%"}}>
        <div className="text-xl font-bold  text-blue-900 mb-5">
        ...
        <p className="bg-pink-200 border-2 h-96 w-96 text-center justify-center p-8 m-10 pt-12" style={{borderRadius:"30%"}}>
        <div className="text-xl font-bold  text-blue-900 mb-5">
